...
jmf_ag <- jm(cox_fit, list(lme_ag, lme_fluid), time_var = "visit_time", n_iter = 1000L, n_burnin = 200L)
...
jmf_lac <- jm(cox_fit, list(lme_lac, lme_fluid), time_var = "visit_time", n_iter = 1000L, n_burnin = 200L)

pdf("Figure_S11_Diagnostics_Lac_Zigong.pdf", width = 10, height = 8)
par(mfrow = c(2, 2))
